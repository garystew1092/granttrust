...
export default function AddItem({ onShowDetails }) {
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            >
              ...
              <option value="Money (cash)">Money (cash)</option>
          ...
          <button
            type="submit"
            className="w-full bg-amber-500 hover:bg-amber-600 text-white py-3 px-4 rounded-md transition-colors mt-6"
          >
            Next Step
          </button>
        </div>
